...
final class Version20240327105231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reset_password_request ADD CONSTRAINT FK_7CE748AA76ED395 FOREIGN KEY (user_id) REFERENCES makeadminview (id)');
        ...
        $this->addSql('ALTER TABLE makeadminview ADD is_verified TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE makeadminview DROP is_verified');
    }
}
